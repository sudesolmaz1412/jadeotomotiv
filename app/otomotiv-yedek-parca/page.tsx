      ...
      <section className="bg-slate-50 px-6 py-14 md:px-10 lg:px-16">
        <div className="mx-auto max-w-5xl">
          <h2 className="text-2xl font-black md:text-3xl">
            İstanbul ve Avcılar oto yedek parça
          </h2>
          <p className="mt-3 leading-7 text-slate-600">
            Bölgesel oto yedek parça aramalarınız için Avcılar sayfamızı,
            tedarik ve fiyat araştırmaları için diğer sayfalarımızı
            inceleyebilirsiniz.
          </p>
          <div className="mt-7 flex flex-wrap gap-3">
            ...
            <a href="/oto-yedek-parca-fiyatlari" className="rounded-xl border border-slate-300 px-5 py-3 font-black">
